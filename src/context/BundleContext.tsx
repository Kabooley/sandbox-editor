...
// export type iBundledCodeActions =
//     ActionMap<iBundledCodeActionsPayload>[keyof ActionMap<iBundledCodeActionsPayload>];

// const BundledCodeContext = createContext<iBundledState>({
//     bundledCode: '',
//     error: null,
// });
// const DispatchBundledCodeContext = createContext<Dispatch<iBundledCodeActions>>(
//     () => null
// );

// function bundledCodeReducer(
//     bundledCode: iBundledState,
//     action: iBundledCodeActions
// ) {
//     switch (action.type) {
//         case Types.Update: {
...
// export const BundledCodeProvider = ({
//     children,
// }: {
