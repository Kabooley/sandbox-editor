...
const EditorSection = (): JSX.Element => {
  ...
  console.log(
    `[EditorSection] desktop editor max width: ${_maximumWidth}, editor width: ${mediaDesktopEditorWidth}`
  )
  console.log(
    `while window.innerWidth: ${window.innerWidth}, window.innerHeight: ${innerHeight}`
  )
  console.log(`EditorSection Height: ${height}`)
